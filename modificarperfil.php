...
<html lang="en">
  ...
  <head>
    ...
    <link rel="icon" href="img/modifperf.jpg" type="image/png">
    <!-- Bootstrap core CSS -->
                      ...
                      <ul class="nav">
                          ...
                          <li class="has-sub">
                              ...
                              <ul class="sub-menu">
                                  ...
                                  <li><a href="modificarperfil.php"class="active">Modificar</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <h6>Modifica o actualiza los perfiles de usuario para administrar su información.</h6>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        ...
        <center>
                ...
                <font color="white"><h4>Ingrese los datos para modificar el perfil</h4>
