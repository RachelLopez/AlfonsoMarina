...
<html lang="en">
  ...
  <head>
    ...
    <link rel="icon" href="img/noti.png" type="image/png">
    <!-- Bootstrap core CSS -->
                      ...
                      <ul class="nav">
                          ...
                          <li class="has-sub">
                              ...
                              <ul class="sub-menu">
                                  ...
                                  <li><a href="notificaciones.php"class="active">Notificaciones</a></li>
                              </ul>
                          </li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <h6>Aquí puedes visualizar las notificaciones que tienes sin revisar.</h6>
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="col-lg-12">
          <div class="row">
            <div class="col-lg-12">
              <div class="filters">
                <ul>
                  <li data-filter="*"  class="active"><h6>Notificaciones<h6></li>
                </ul>
              </div>
            </div>
            <div class="col-lg-12">
