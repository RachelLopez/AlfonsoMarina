                      ...
                      <ul class="nav">
                          ...
                          <li class="has-sub">
                              ...
                              <ul class="sub-menu">
                                  ...
                                  <li><a href="reportepersonal.php " class="active">Personal</a></li>
                              </ul>
                          </li>
                          </ul>        
    ...
    <div class="container">
      <div class="row">
        ...
        <center>
                ...
                <font color="white"><h4>Ingrese los datos para generar reporte a algún personal en específico</h4>

                <form  class="form" method="POST" action="guardar_contacto.php" >

                <div class="form-group">
                  <center><label for="idusuario">Id del usuario: </label></center>
                  <input type="text" required name="idusuario" placeholder="Ingrese el id del usuario..." class="form-control" id="idusuario" >
                </div>
                ...
                <div class="form-group">
                  <center><label for="reportusuario">Reporte para usuario: </label></center></font>
                  <input type="text" required name="reportusuario" placeholder="Ingrese su reporte." class="form-control" id="reportusuario">
                </div>
