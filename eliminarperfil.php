...
<html lang="en">
  ...
  <head>
    ...
    <link rel="icon" href="img/delper.jpg" type="image/png">
    <!-- Bootstrap core CSS -->
                      ...
                      <ul class="nav">
                          ...
                          <li class="has-sub">
                              ...
                              <ul class="sub-menu">
                                  ...
                                  <li><a href="eliminarperfil.php"class="active">Eliminar</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <h6>Elimina perfiles de usuario.</h6>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        ...
        <center>
                ...
                <font color="white"><h4>Ingrese los datos para eliminar el perfil</h4>
