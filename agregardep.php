              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li><a href="agregardep.php" class="active">Agregar departamentos</a></li>
                          <li class="has-sub">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <h6>Añade más deprtamentos para poder llevar un control<br>
           y evaluación de su desempeño.</h6>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row">
        <div class="col-lg-12">
            <center>
              ...
              <font color="white"><h4>Ingrese los datos para añadir al departamento</h4>
